...
from tensorflow.keras.layers import Input, Dense, Concatenate, Layer, MultiHeadAttention, LayerNormalization, Flatten
...
class Bert(BaseModel):
    ...
    def build(self):
        ...
        for feature in PARAMS.FEATURES:
            ...
            # feature_proj = Dense(PARAMS.PROJ_DIM, activation='relu')(feature_embedding)
            feature_proj = feature_embedding
        ...
        attention_layer = MultiHeadAttention(num_heads=PARAMS.NUM_HEADS, key_dim=PARAMS.PROJ_DIM//PARAMS.NUM_HEADS)
        ...
        # fl_output = Flatten()(concatenated_features)
